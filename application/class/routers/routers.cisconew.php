...
class CiscoNew
{
    ...
    public function Login($Host,$User,$Pass)
    {
        ...
        $this->ch = curl_init();
        curl_setopt($this->ch, CURLOPT_URL, "http://{$Host}/goform/Docsis_system");
        curl_setopt($this->ch, CURLOPT_HEADER, 1);
        curl_setopt($this->ch, CURLOPT_POST, 1);
        curl_setopt($this->ch, CURLOPT_POSTFIELDS, "username_login={$User}&password_login={$Pass}&Language_Submit=0");
        ...
        $headers = array();
        $headers[] = "Cookie: Lang=en; SessionID=";
        ...
        $headers[] = "Referer: http://{$Host}/Docsis_system.asp";
