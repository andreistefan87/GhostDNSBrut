...
class DIR610o
{
    ...
    public function ChangeDNS($Host,$User,$Pass,$DNS1,$DNS2)
    {
        if ($this->Auth)
        {
            ...
            curl_setopt($this->ch, CURLOPT_POSTFIELDS, "dns_ctrl=1&wan_dns1=107.155.152.15&wan_dns2=8.8.8.8&wan_dns3=0.0.0.0&wanspeed=0&mac_clone_value=C4%3AA8%3A1D%3AF2%3A0F%3A1F&mac_default_value=C4%3AA8%3A1D%3AF2%3A0F%3A1F&mac_client_value=&mac_clone_display=0&submit.htm%3Fwan.htm=Send&save=Aplicar+mudan%C3%A7as");
            curl_setopt($this->ch, CURLOPT_POST, 1);
